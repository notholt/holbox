...
public class StringParameter extends Parameter<String>{
	 ...
	 */
	public StringParameter(String varName, String name, String unit, String def) 
	{
	...
	public StringParameter(String varName, String name, String unit, String def, int lines) 
	{
		this.varName 	= varName;
		this.name 		= name;
		this.unit		= unit;
